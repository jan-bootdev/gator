...
VALUES ($1,
        ...
        $4,
        $5,
        $6) RETURNING id, created_at, updated_at, name, url, user_id, last_fetched_at
`
...
SELECT id, created_at, updated_at, name, url, user_id, last_fetched_at FROM feeds WHERE id IN (SELECT feed_id FROM feed_follows WHERE feed_follows.user_id = $1)
`
